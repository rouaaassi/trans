...
export const Logo: FC<IconProps> = ({ className }) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M16 4C9.373 4 4 9.373 4 16s5.373 12 12 12 12-5.373 12-12S22.627 4 16 4zm0 22c-5.523 0-10-4.477-10-10S10.477 6 16 6s10 4.477 10 10-4.477 10-10 10z"
        fill="currentColor"
      />
    </svg>
  );
...
export const SunFilledIcon: FC<IconProps> = ({ className }) => (
  <svg
    className={className}
    fill="currentColor"
    height="24"
...
export const MoonFilledIcon: FC<IconProps> = ({ className }) => (
  <svg
    className={className}
    fill="currentColor"
    height="24"
