...
export default function Home() {
  ...
  return (
    <section className="bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 min-h-screen">
      <div className="flex flex-col items-center justify-center gap-8 py-20 px-4">
        <div className="inline-block max-w-4xl text-center justify-center">
          <h1 className={title({ size: "lg" })}>
            Transform Your Live Streams with{" "}
            <span className="text-primary">Real-Time Translation</span>
          </h1>
          <h2 className={subtitle({ class: "mt-6 text-xl" })}>
            Break language barriers and reach a global audience instantly.
            Powered by advanced AI technology.
          </h2>
        </div>

        <div className="flex flex-col gap-4 w-full max-w-3xl items-center justify-center">
          <div className="relative mt-6 mb-4 bg-white dark:bg-gray-800 w-full rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-center mb-8 max-w-2xl">
                Connect your live stream URL and let our AI-powered system
                handle the rest. Get instant translations in multiple languages.
              </p>
          ...
          <div className="text-center text-sm text-gray-500 dark:text-gray-400 mt-4">
            <span>
              By using TransLive, you agree to our{" "}
        ...
        <div className="relative mx-w-7xl mx-4 px-6 lg:px-8 lg:mx-auto ">
          <div className=" relative mx-w-7xl mx-4 px-6 lg:px-8 lg:mx-auto pt-8">
            <p className="block mb-4 text-gray-500 text-lg ">
              ...
              can be sure you&apos;re getting accurate results. Use our free
              video transcription tool for a wide range of uses from social
              media videos to podcasts.
            </p>
          </div>
        </div>
      </div>
      <div className="flex flex-col md:items-center md:flex-row items-start justify-center md:space-x-2 gap-2 pl-10  pt-24">
        <div>
          <h2 className="font-bold text-3xl mb-6">Secure and easy to use</h2>
          <p className="text-gray-600 dark:text-gray-300 text-lg">
            You don&apos;t have to download any software to use our AI video
            transcription tool. You also don&apos;t need to create an account,
            and we don&apos;t show ads. After you&apos;re done transcribing your
            video, we&apos;ll delete your data from our servers.
          </p>
        </div>
        <img
      ...
      <div className="flex flex-col md:items-center md:flex-row items-start justify-center md:space-x-2 gap-2 pl-10 pt-24">
        <div>
          ...
          <p className="block mb-4 text-gray-500 text-lg mt-10">
            Use{" "}
            <a href="https://restream.io/studio">
              Restream Studio&apos;s record-only mode
            </a>{" "}
            to record a new video. You can take advantage of features like
            custom captions, backgrounds and logos, as well as add remote guests
            and change screen layouts. When you&apos;re done recording, download
            your video, then use our AI video-to-text converter to get the
            transcription and add subtitles.
          </p>
        </div>
        <img
          alt="Convert File to Audio"
      ...
      <div className=" mx-w-7xl w-full mx-4 px-6 lg:px-8 lg:mx-auto pt-4  border-t-1  border-gradient-to-r from-orange-400 via-white mb-9" />
