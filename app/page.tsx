        ...
        <div className="flex flex-wrap justify-center items-center box-border gap-6">
          ...
          >
            ...
            <span class="block text-center mt-5">
              <span class="block text-lg text-gray-300">Camera Test</span>
              <span class="block text-sm text-gray-400">Test your webcam</span>
            </span>
          </a>
          <a
            href="/tools/audio-converter"
            class="block basis-full sm:basis-[48%] lg:basis-[25%] box-border p-8 border rounded-lg border-gray-700/[0.4] bg-gray-700/[0.3] py-10"
          >
            <span class="block">
              <svg
                width="48"
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                class="block mx-auto w-12 h-12 text-gray-400"
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
          ...
          >
            ...
            <span class="block text-center mt-5">
              <span class="block text-lg text-gray-300">
